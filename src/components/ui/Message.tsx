...
const Message = (t: Props) => {
  ...
  switch (t.type) {
    case "loading":
      ...
      break;
    case "error":
      icon = <BiMessageSquareError className="w-[96%] h-[96%] mt-2 ml-[-8px] text-neutral-950 dark:text-neutral-100" />;
      state = `죄송합니다.<br/>컨텐츠 준비가 아직 안 되어있습니다.`;
      text = `빠른 시일 내에 다시 찾아뵙겠습니다.`;
      break;
    case "notFound":
      icon = <TbFaceIdError className="w-[96%] h-[96%] mt-2 ml-[-8px] text-neutral-950 dark:text-neutral-100" />;
